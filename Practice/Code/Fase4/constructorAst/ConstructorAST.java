...
/** CUP v0.11b beta 20140220 generated parser.
  * @version Sat Jun 23 15:18:40 CEST 2018
  */
public class ConstructorAst extends java_cup.runtime.lr_parser {
  ...
  protected static final short _production_table[][] = 
    ...
    "\000\040\000\002\004\003\000\002\002\004\000\002\005" +
    "\005\000\002\006\006\000\002\006\006\000\002\006\004" +
    "\000\002\006\004\000\002\010\007\000\002\010\005\000" +
  ...
  protected static final short[][] _reduce_table = 
    unpackFromStrings(new String[] {
    "\000\076\000\010\004\004\005\005\006\007\001\001\000" +
    "\002\001\001\000\002\001\001\000\002\001\001\000\002" +
    "\001\001\000\002\001\001\000\002\001\001\000\004\010" +
    "\013\001\001\000\002\001\001\000\002\001\001\000\002" +
    "\001\001\000\002\001\001\000\016\012\020\013\032\014" +
    "\031\015\030\016\027\017\025\001\001\000\006\016\066" +
    "\017\025\001\001\000\002\001\001\000\002\001\001\000" +
    "\002\001\001\000\016\012\060\013\032\014\031\015\030" +
    ...
    "\036\014\031\015\030\016\027\017\025\001\001\000\012" +
    "\014\035\015\030\016\027\017\025\001\001\000\002\001" +
    "\001\000\002\001\001\000\010\015\056\016\027\017\025" +
    "\001\001\000\010\015\055\016\027\017\025\001\001\000" +
    "\010\015\054\016\027\017\025\001\001\000\010\015\053" +
    "\016\027\017\025\001\001\000\010\015\052\016\027\017" +
    "\025\001\001\000\006\016\051\017\025\001\001\000\006" +
    "\016\050\017\025\001\001\000\010\015\047\016\027\017" +
    "\025\001\001\000\002\001\001\000\002\001\001\000\002" +
    "\001\001\000\002\001\001\000\002\001\001\000\002\001" +
    "\001\000\002\001\001\000\002\001\001\000\002\001\001" +
    "\000\002\001\001\000\002\001\001\000\014\013\065\014" +
    "\031\015\030\016\027\017\025\001\001\000\014\013\064" +
    "\014\031\015\030\016\027\017\025\001\001\000\002\001" +
    "\001\000\002\001\001\000\002\001\001\000\016\012\070" +
    "\013\032\014\031\015\030\016\027\017\025\001\001\000" +
    "\002\001\001\000\002\001\001\000\002\001\001\000\002" +
    "\001\001\000\002\001\001\000\002\001\001\000\002\001" +
    "\001\000\002\001\001" });
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$ConstructorAst$act_num)
		...
		Prog aPROG = (Prog)((java_cup.runtime.Symbol) CUP$ConstructorAst$stack.peek()).value;
		 RESULT=aPROG; 
              CUP$ConstructorAst$result = parser.getSymbolFactory().newSymbol("S",2, RESULT);
            }
		...
		LIs aLINS = (LIs)((java_cup.runtime.Symbol) CUP$ConstructorAst$stack.peek()).value;
		 RESULT=as.prog(aLDEC, aLINS); 
              CUP$ConstructorAst$result = parser.getSymbolFactory().newSymbol("Prog",3, RESULT);
            }
          return CUP$ConstructorAst$result;
		...
		String lexID = (String)((java_cup.runtime.Symbol) CUP$ConstructorAst$stack.peek()).value;
		 RESULT=as.ldec(aLDEC, lexNUM, lexID); 
              CUP$ConstructorAst$result = parser.getSymbolFactory().newSymbol("LDec",4, RESULT);
            }
          return CUP$ConstructorAst$result;
		...
		E aEXP0 = (E)((java_cup.runtime.Symbol) CUP$ConstructorAst$stack.peek()).value;
		 RESULT=as.lins(aLINS, lexID, aEXP0); 
              CUP$ConstructorAst$result = parser.getSymbolFactory().newSymbol("LIns",6, RESULT);
            }
          return CUP$ConstructorAst$result;
		...
		E aEXP1 = (E)((java_cup.runtime.Symbol) CUP$ConstructorAst$stack.peek()).value;
		 RESULT=as.minus(aEXP0, aEXP1); 
              CUP$ConstructorAst$result = parser.getSymbolFactory().newSymbol("Exp0",8, RESULT);
            }
          return CUP$ConstructorAst$result;
		...
		E aEXP1 = (E)((java_cup.runtime.Symbol) CUP$ConstructorAst$stack.peek()).value;
		 RESULT=as.and(aEXP2, aEXP1); 
              CUP$ConstructorAst$result = parser.getSymbolFactory().newSymbol("Exp1",9, RESULT);
            }
          return CUP$ConstructorAst$result;
		...
		E aEXP31 = (E)((java_cup.runtime.Symbol) CUP$ConstructorAst$stack.peek()).value;
		 RESULT=as.eq(aEXP30, aEXP31); 
              CUP$ConstructorAst$result = parser.getSymbolFactory().newSymbol("Exp2",10, RESULT);
            }
          return CUP$ConstructorAst$result;
		...
		E aEXP4 = (E)((java_cup.runtime.Symbol) CUP$ConstructorAst$stack.peek()).value;
		 RESULT=as.mul(aEXP3, aEXP4); 
              CUP$ConstructorAst$result = parser.getSymbolFactory().newSymbol("Exp3",11, RESULT);
            }
          return CUP$ConstructorAst$result;
		...
		E aEXP4 = (E)((java_cup.runtime.Symbol) CUP$ConstructorAst$stack.peek()).value;
		 RESULT=as.sign(aEXP4); 
              CUP$ConstructorAst$result = parser.getSymbolFactory().newSymbol("Exp4",12, RESULT);
            }
          return CUP$ConstructorAst$result;
		...
		String lexLREAL = (String)((java_cup.runtime.Symbol) CUP$ConstructorAst$stack.peek()).value;
		 RESULT=as.num(lexLREAL); 
              CUP$ConstructorAst$result = parser.getSymbolFactory().newSymbol("Exp5",13, RESULT);
            }
          return CUP$ConstructorAst$result;
