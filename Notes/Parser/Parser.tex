...
\begin{document}
  ...
  \section{Implementación}
    ...
    \subsection{Resolución por aproximaciones sucesivas}
      ...
      con multiples equiaciones del tipo:
      \begin{center}
        \hspace{1mm}\overrightarrow{x} = $\Phi$ [\overrightarrow{x}], \overrightarrow{x} $in$ U con U finito.\\
      ...
      \begin{center}
        \hspace{1mm}\overrightarrow{$x_0$}: \overrightarrow{$x_{0 i}$} = \O para cada i.\\
        \hspace{1mm}\overrightarrow{$x_{n+1}$} = $\Phi$(\overrightarrow{$X_n$})
      \end{center}
\end{document}